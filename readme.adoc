...
Use the 2 working toy-trucks to build a cooperative, learning-based autonomous 'racing' system. The trucks will explore, map, optimize speed per segment, and avoid dynamic obstacles on a simple bounded track.
...
Link to the complete project description for ScaniaHack 2026: link:doc/ESP32_Truck_Hackathon_Project_Description.pdf[ScaniaHack 2026 project description]

### The simple track
Built with 45x70mm wood-planks, the track will be a closed with a clear start/finish line and a few curves and obstacles.
